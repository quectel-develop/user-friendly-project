...
void bg95_mqtt_connect_cb(struct at_client *client, const char *data, s32_t size)
{
	LOG_D("DATA[%d]: %s\r\n", size, data);
}

void bg95_mqtt_qmtopen_cb(struct at_client *client, const char *data, s32_t size)
{
	LOG_D("DATA[%d]: %s\r\n", size, data);
...
void bg95_mqtt_qmtconn_cb(struct at_client *client, const char *data, s32_t size)
{
	LOG_D("DATA[%d]: %s\r\n", size, data);
	int protocol_err = 0;
...
void bg95_mqtt_qmtsub_cb(struct at_client *client, const char *data, s32_t size)
{
	LOG_D("DATA[%d]: %s\r\n", size, data);
	int result = 0;
...
void bg95_mqtt_qmtpub_cb(struct at_client *client, const char *data, s32_t size)
{
	LOG_D("DATA[%d]: %s\r\n", size, data);
	int result = 0;
...
void bg95_mqtt_qmtstat_cb(struct at_client *client, const char *data, s32_t size)
{
	LOG_D("DATA[%d]: %s\r\n", size, data);
	int result = 0;
     int client_idx = 0;
...
void bg95_mqtt_qmtdisc_cb(struct at_client *client, const char *data, s32_t size)
{
	LOG_D("DATA[%d]: %s\r\n", size, data);
	int result = 0;
...
void bg95_mqtt_urc_cb(struct at_client *client, const char *data, s32_t size)
{
	char tmp[4];
	int idx;
	int num_messages;
