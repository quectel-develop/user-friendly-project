...
typedef void (*at_evt_cb_t)(struct at_socket *socket, at_socket_evt_t event, const char *buff, size_t bfsz, s64_t pkt_type);
...
{
    int (*at_connect)(struct at_socket *socket, char *ip, int32_t port, enum at_socket_type type, qosa_bool_t is_client);
    int (*at_closesocket)(struct at_socket *socket);
    int (*at_send)(struct at_socket *socket, const char *buff, size_t bfsz, char *ip, int32_t port, enum at_socket_type type, qosa_bool_t is_client);
...
struct at_socket
{
    ...
    osa_sem_t recv_notice;
    osa_mutex_t recv_lock;
